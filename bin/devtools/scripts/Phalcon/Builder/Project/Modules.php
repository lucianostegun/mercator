...
class Modules extends ProjectBuilder
{
    ...
    protected $projectDirectories = [
        ...
        'app/modules/backend/models',
        'app/modules/backend/controllers',
        'app/modules/backend/views/index',
        'app/modules/backend/views/layouts',
        'app/modules/cli',
    ...
    private function createControllerFile()
    {
        ...
        $builder = new ControllerBuilder([
            'name'           => 'index',
            'controllersDir' => $this->options->get('projectPath') . 'app/modules/backend/controllers/',
    ...
    private function createIndexViewFiles()
    {
        ...
        $putFile = $this->options->get('projectPath') . 'app/modules/backend/views/index.volt';
        $this->generateFile($getFile, $putFile);

        $getFile = $this->options->get('templatePath') . '/project/modules/views/index/index.volt';
        $putFile = $this->options->get('projectPath') . 'app/modules/backend/views/index/index.volt';
        $this->generateFile($getFile, $putFile);
    ...
    private function createControllerBase()
    {
        ...
        $putFile = $this->options->get('projectPath') . 'app/modules/backend/controllers/ControllerBase.php';
        $this->generateFile($getFile, $putFile, $this->options->get('name'));
    ...
    private function createModules()
    {
        ...
        $putFile = $this->options->get('projectPath') . 'app/modules/backend/Module.php';
        $this->generateFile($getFile, $putFile, $this->options->get('name'));
